...
// void controller::admittanceCtrl_Tra(StateModel_* state_model, trajectory tra, int flag)
// {
//     // 현재 omega_n, zeta, k 로 tunning 하고 있는데, 변환식을 통해 아래에 적어주면 된다
//     ad_M = tra.tra_k/(pow(tra.tra_omega,2));
//     ad_B = 2*tra.tra_zeta*tra.tra_k/tra.tra_omega;
//     ad_K = k;
