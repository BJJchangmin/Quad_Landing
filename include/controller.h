...
public:
    ...
    void admittanceCtrl(StateModel_* state_model, double omega_n, double zeta, double k, int flag);
    void admittanceCtrl_Tra(StateModel_* state_model, trajectory* tra, int flag);
